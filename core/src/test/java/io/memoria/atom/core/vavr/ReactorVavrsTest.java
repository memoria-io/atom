...
class ReactorVavrsTest {
  ...
  @Test
  void booleanToMono() {
    var v = ReactorVavrUtils.toMono(() -> "hello world", new Exception("isFalse"));
  ...
  void toMonoFromOption() {
    ...
    var non = Option.none();
    // When
    var somMono = ReactorVavrUtils.toMono(som, new IllegalArgumentException("not found"));
    var nonMono = ReactorVavrUtils.toMono(non, new IllegalArgumentException("not found"));
    // Then
