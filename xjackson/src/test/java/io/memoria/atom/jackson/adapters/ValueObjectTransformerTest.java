...
import io.memoria.atom.jackson.adapters.value.Person;
import io.memoria.atom.jackson.adapters.value.SomeId;
...
class ValueObjectTransformerTest {
  ...
  @Test
  void valueObjectInsideAnother() throws TextException {
    // Given
    var jsonStr = """
            {
              "$type":"Person",
