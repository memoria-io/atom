...
import static io.memoria.atom.es.active.cassandra.client.TestUtils.KEYSPACE;
import static io.memoria.atom.es.active.cassandra.client.TestUtils.getClientConfig;
