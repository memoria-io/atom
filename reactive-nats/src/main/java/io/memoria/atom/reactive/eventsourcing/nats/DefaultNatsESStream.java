...
class DefaultNatsESStream implements NatsESStream {
  private static final Logger log = LoggerFactory.getLogger(DefaultNatsESStream.class.getName());
  private final Config config;
  private final Connection nc;
  private final JetStream js;

  DefaultNatsESStream(Config config) throws IOException, InterruptedException {
    this.config = config;
