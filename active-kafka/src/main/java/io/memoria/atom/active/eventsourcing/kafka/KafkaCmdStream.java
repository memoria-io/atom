...
public class KafkaCmdStream implements CmdStream {
  private final Duration pollDuration;
  private final KafkaProducer<String, String> producer;
  private final KafkaConsumer<String, String> consumer;

  public KafkaCmdStream(Duration pollDuration, Map<String, Object> producerConfig, Map<String, Object> consumerConfig) {
  ...
  public Stream<CmdMsg> sub(String topic, int partition) {
    return KafkaUtils.stream(consumer, topic, partition, pollDuration).map(KafkaCmdStream::toMessage);
  }
